...
* Create a separate R code file (plot1.R, plot2.R, etc.) that constructs the corresponding plot, i.e. code in plot1.R constructs the
  plot1.png plot. Your code file should include code for reading the data so that the plot can be fully reproduced. You should also
  include the code that creates the PNG file. Only include the code for a single plot (i.e. plot1.R should only include code for
  producing plot1.png)
...
1. Have total emissions from PM2.5 decreased in the United States from 1999 to 2008? Using the base plotting system, make a plot 
   ...
   Answer: As can can be seen from the plot_1, total emissions have decreased from 1999 to 2008.
...
2. Have total emissions from PM2.5 decreased in the Baltimore City, Maryland (fips == "24510") from 1999 to 2008? Use the base plotting 
   ...
   Answer: Besides the variation the total emissions from PM2.5 have decreased from 1999 to 2008 for the city of Baltimore, Maryland.
...
3. Of the four types of sources indicated by the type (point, nonpoint, onroad, nonroad) variable, which of these four sources 
   ...
   Answer: The `non-road`, `nonpoint`, `on-road` source types have all seen decreased emissions from 1999-2008 in Baltimore City.

   Which have seen increases in emissions from 1999–2008? Use the ggplot2 plotting system to make a plot answer this question.

   Answer: The `point` source had an increase from 1999 to 2005 and a decrease from 2005 to 2008 but this last year had an increase
...
4. Across the United States, how have emissions from coal combustion-related sources changed from 1999–2008?
   ...
   Answer: Those emissions have decreased from about 5.5 * 10^5 to above 4 * 10^5 from 1999 to 2008 despite the fact that from 2002 to
           2005 a slightly increase can be seen.
           

++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
5. How have emissions from motor vehicle sources changed from 1999–2008 in Baltimore City?

   Answer: Those emissions have decreased more than a half from 1999 to 2008.
